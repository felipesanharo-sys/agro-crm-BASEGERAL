...
--> statement-breakpoint
CREATE INDEX `idx_ib_upload` ON `invoices_backup` (`uploadHistoryId`);--> statement-breakpoint
CREATE INDEX `idx_ib_order` ON `invoices_backup` (`orderCode`);--> statement-breakpoint
CREATE INDEX `idx_uh_date` ON `upload_history` (`uploadedAt`);--> statement-breakpoint
CREATE INDEX `idx_uh_status` ON `upload_history` (`status`);